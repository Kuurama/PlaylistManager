...
namespace PlaylistManager.AffinityPatches
{
    ...
    internal class AnnotatedBeatmapLevelCollectionsUIPatches : IAffinity
    {
        ...
        private const int FallbackBaseColumnCount = 7;
        ...
        {
            var playlistAnimator = _annotatedBeatmapLevelCollectionsViewController
            ...
            // Beat Saber 1.39.1 needs the original PlaylistManager left margin after
